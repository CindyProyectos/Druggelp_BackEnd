...
public class CartServiceImpl implements CartService {
    ...
    @Override
    public Cart getCart(Usuario user) {
        return user.getCart();
    }

    @Override
    @Transactional
    public void mergeLocalCart(Collection<ProductInOrder> productInOrders, Usuario user) {
    ...
    @Override
    @Transactional
    public void delete(String itemId, Usuario user) {
    ...
    @Override
    @Transactional
    public void checkout(Usuario user) {
        // Creat an order
